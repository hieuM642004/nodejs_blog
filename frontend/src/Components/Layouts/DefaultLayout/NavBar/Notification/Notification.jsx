...
function Notification() {
	...
	return (
		<div className='mr-2'>
			...
			>
				<FontAwesomeIcon icon={faBell} className='w-10 h-5'/>
			</button>
			<ul
				role="menu"
				...
				className={`${
					open ? '' : 'hidden'
				}  absolute  z-10 flex min-w-[180px] flex-col gap-2 overflow-auto rounded-md border border-blue-gray-50 bg-white p-3 font-sans text-sm font-normal text-blue-gray-500 shadow-lg shadow-blue-gray-500/10 focus:outline-none`}
			>
				<button
					role="menuitem"
